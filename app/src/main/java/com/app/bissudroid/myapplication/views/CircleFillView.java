package com.app.bissudroid.myapplication.views;
...
public class CircleFillView extends View {
    ...
    public CircleFillView(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            strokeWidths = a.getFloat(R.styleable.CircleFillView_strokeWidths, 1f);
        ...
        strokePaint.setStrokeWidth(strokeWidths);
    ...
    public void setStrokeWidth(float strokeWidths)
    {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh)
    {
        ...
        radius = Math.min(getWidth(), getHeight()) / 2 - (int) strokeWidths;
